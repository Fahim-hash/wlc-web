...
export default function DevelopersPage() {
  return (
    // বাইরের এই কন্টেনারটি পুরো স্ক্রিন জুড়ে #FAFAFA ব্যাকগ্রাউন্ড নিশ্চিত করবে
    <main className="w-full min-h-screen bg-[#FAFAFA] text-gray-800 font-sans">
      
      {/* ভেতরের এই ডিভটি কন্টেন্টকে সর্বোচ্চ ৫এক্সএল উইডথ দিয়ে মাঝখানে ধরে রাখবে */}
      <div className="max-w-5xl mx-auto p-8 md:p-16 min-h-screen flex flex-col justify-center">
