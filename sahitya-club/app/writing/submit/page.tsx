...
export default function WritingSubmitPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title || !formData.content) {
      setStatus({ type: "error", message: "শিরোনাম এবং লেখার মূল অংশ দেওয়া বাধ্যতামূলক ভাই!" });
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.message || "সাবমিশনে কোনো সমস্যা হয়েছে।");
      }

      setStatus({ type: "success", message: "আগুন! তোমার লেখাটি আমাদের ব্যাকএন্ডে সিকিউরডভাবে জমা হয়েছে। ✒️" });
      setFormData({ title: "", category: "poetry", content: "", penName: "" }); // ফর্ম রিসেট
    } catch (error: any) {
      setStatus({ type: "error", message: error.message || "সার্ভার এরর! দয়া করে আবার চেষ্টা করো।" });
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <main className="min-h-screen bg-[#FAFAFA] text-gray-800 font-sans p-6 md:p-12 max-w-3xl mx-auto">
      ...
      <div className="bg-stone-900 text-stone-100 rounded-3xl p-6 mb-8 border border-stone-800 shadow-xl">
        ...
        <p className="text-xs text-stone-400 leading-relaxed">
          উইলস সাহিত্য ক্লাবের সিকিউরড পোর্টালে তোমাকে স্বাগতম। তোমার সাবমিট করা প্রতিটি ডাটা সম্পূর্ণ এনক্রিপ্টেড অবস্থায় ডাটাবেজে জমা হবে। কোনো প্রকার কপি বা স্প্যামিং কোড সেন্ড করার চেষ্টা করলে আইপি ব্লক করা হতে পারে।
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-3xl p-6 md:p-8 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <select 
              className="w-full bg-stone-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-rose-800 transition-colors appearance-none"
        ...
        <div>
          ...
          <textarea 
            ...
            placeholder="এখানে তোমার মনের মাধুরী মিশিয়ে লেখো..."
        ...
        <button 
          type="submit"
          disabled={loading}
          className="w-full bg-stone-950 text-white font-semibold text-sm py-4 rounded-xl hover:bg-rose-900 transition-colors shadow-md disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
