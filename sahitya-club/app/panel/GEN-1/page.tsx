...
export default function RunningCommittee() {
  ...
  { id: 10, name: "মোল্লা সৌম্য রহমান", role: "নিয়ন্ত্রক (ইংরেজি সাহিত্য)", batch: "HSC '27", image: "/panel/shoummo.jpg" },
  ...
  { id: 15, name: "ইয়ামিন উজ জামান", role: "চিত্র ও নথি সংগ্রাহক", batch: "HSC '26", image: "/panel/yeamin.HEIC.heic" },
